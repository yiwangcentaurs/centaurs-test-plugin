...
var App = {
	...
	app_name: '',
	/**
	 * minimum test interval time in milliseconds (at least 1 min)
	 * @private
	 */
	test_min_interval: 1000 * 60,
	sys_check_min_interval: 1000 * 60,
	...
	createPlugin: function () {
		 ...
		 * @param {number} [interval>=test_min_interval] - interval (in milliseconds)
		 */
		...
		/**
		 * send system info at specified intervals (in milliseconds).
		 * @param {number} [interval>=sys_check_min_interval] - interval (in milliseconds)
		 */
		...
		app.showConfig = function () {
			var config = [
				...
				`test_min_interval: ${App.test_min_interval}ms (${App.test_min_interval / 60000}min)`,
				`sys_check_min_interval: ${App.sys_check_min_interval}ms (${App.sys_check_min_interval / 60000}min)`,
